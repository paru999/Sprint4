...
<div class=" col-md-2">
 <img src= ${img} vertical-align= "left" width= "20%">${UserName} ${LastName}  <br><br>
...
<form:form name="search" method="Post" action="/spring2/confirmrequest" modelAttribute="SearchBean " id="srchform" >
 ...
 <div class="row">
   <div class=" col-md-2">
	...
	<div class=" col-md-2">
	<a href="/spring2/confm?id=<c:out value="${tbl_user.pk_int_UID}"/>" style="color:grey;">confirm</a></div>
 <div class=" col-md-3">
  <a href="/spring2/delete?id=<c:out value="${tbl_user.pk_int_UID}"/>" style="color:grey;"> Delete Request</a>  </div>     
 </div>
  </c:forEach>
   </form:form>
</div>
